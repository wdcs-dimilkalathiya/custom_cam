  ...
  Future<void> _initializeAudioController() async {
    if (_audioFile != null) {
      audioPlayerController.playerStateStream.listen((event) {
        final bool isPlaying = audioPlayerController.playing;
      ...
      _audioDuration = (audioPlayerController.duration)!.inMilliseconds;
    }
  }
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        audioPlayerController.playing
                            ...
                            : Container(),
                        Text(
                          Duration(milliseconds: _audioEndPos.toInt()).format(widget.durationStyle),
                          style: widget.durationTextStyle,
                        ),
                      ],
                    ),
              ...
              ? SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Text(
                          const Duration(milliseconds: 0).format(widget.durationStyle),
                          style: widget.durationTextStyle,
                        ),
                        Text(
                          Duration(milliseconds: audioPlayerController.duration?.inMilliseconds ?? 0)
