import 'dart:io';
import 'package:example/video_editor/models/cover_data.dart';
import 'package:example/video_editor/models/cover_style.dart';
import 'package:example/video_editor/models/crop_style.dart';
import 'package:example/video_editor/models/trim_style.dart';
import 'package:example/video_editor/utils/helpers.dart';
import 'package:example/video_editor/utils/thumbnails.dart';
...
class VideoMinDurationError extends Error {
  ...
  final VoidCallback? onTrimChange;

  VideoMinDurationError(this.minDuration, this.videoDuration, this.onTrimChange);
...
class VideoEditorController extends ChangeNotifier {
  ...
  /// ```
  Future<void> initialize({double? aspectRatio, bool handleListener = true}) async {
    await _video.initialize();

    if (minDuration > videoDuration) {
      throw VideoMinDurationError(minDuration, videoDuration, onTrimChange);
    }
